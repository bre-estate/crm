  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 py-6">
      <div>
        ...
        <h1 className="text-2xl font-bold mt-1">Hướng dẫn nhập ĐC giá vốn</h1>
        <p className="text-sm text-slate-500 mt-1">
          Dành cho admin (Tường Vi, Nga) khi nhập cost reconciliation trên CRM.
          Đồng bộ với Excel BCDT sheet 2.3_Gia von.
        </p>
      </div>

      <section className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h2 className="font-semibold text-blue-900 mb-2">🎯 2 field quan trọng nhất</h2>
        <ul className="text-sm space-y-2 text-slate-700">
          ...
          <li>
            <b>M — %PMG_LK_sale (%):</b> <b>cumulative</b> rate CĐT đã chi cho cty đến đợt này.
            <br />
      ...
      <section>
        <h2 className="text-lg font-semibold mb-3">📝 3 sample cases</h2>

        <div className="space-y-4">
          {/* CASE 1 */}
          <div className="bg-card rounded-lg ring-1 ring-slate-200 p-4">
            <div className="flex items-baseline justify-between">
              <h3 className="font-semibold">Case 1: Pattern CŨ — CĐT chi 1 lần khi khách trả tới mốc</h3>
              <span className="text-xs px-2 py-0.5 rounded bg-slate-100 text-slate-600">Bcons, Phú Đông, căn cũ AVIO</span>
            </div>
            <p className="text-sm text-slate-600 mt-2">
              Rate M tăng khi tiến độ N tăng. Mỗi lần khách trả tới mốc, CĐT chi ngay rate tương ứng (1 lần).
            </p>
            <div className="mt-3 bg-slate-50 rounded p-3">
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="tabular-nums">
                  ...
                  <tr className="border-t"><td className="p-1">3</td><td className="p-1">15/03</td><td className="p-1 text-right">100%</td><td className="p-1 text-right">7.00%</td><td className="p-1 text-slate-500">Full HĐ khi khách trả 100%</td></tr>
                </tbody>
              </table>
              <div className="text-[10px] text-slate-500 mt-2 italic">
                Đặc điểm: N tăng → M tăng. Mỗi mốc N chỉ có 1 đợt ĐC.
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg ring-1 ring-amber-200 p-4">
            <div className="flex items-baseline justify-between">
              <h3 className="font-semibold">Case 2: Pattern MỚI — CĐT chi rải rác nhiều đợt cùng mốc N</h3>
              <span className="text-xs px-2 py-0.5 rounded bg-amber-100 text-amber-700">AVIO Dataloca 2026</span>
            </div>
            <p className="text-sm text-slate-600 mt-2">
              N giữ nguyên nhưng M tăng dần vì CĐT chi trả rate theo lịch riêng (không cùng lúc khách trả).
            </p>
            <div className="mt-3 bg-slate-50 rounded p-3">
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="tabular-nums">
                  <tr className="border-t"><td className="p-1">1</td><td className="p-1">04/07</td><td className="p-1 text-right">70%</td><td className="p-1 text-right">6.75%</td><td className="p-1 text-slate-500">CĐT chi lần 1 (chưa full)</td></tr>
              ...
              <div className="text-[10px] text-slate-500 mt-2 italic">
                Đặc điểm: N giữ 70% qua 3 đợt, M tăng theo lịch CĐT release.
          ...
          <div className="bg-card rounded-lg ring-1 ring-red-200 p-4">
            <div className="flex items-baseline justify-between">
              <h3 className="font-semibold">Case 3: CĐT tăng rate ceiling HĐ (VD 7% → 8%)</h3>
              <span className="text-xs px-2 py-0.5 rounded bg-red-100 text-red-700">Hiếm gặp</span>
            </div>
            <p className="text-sm text-slate-600 mt-2">
              CĐT sửa HĐ tăng rate tổng lên. Cần update ceiling trong CRM TRƯỚC khi nhập ĐC mới.
            </p>
            <div className="mt-3 bg-slate-50 rounded p-3 text-sm">
              ...
              <ol className="list-decimal list-inside space-y-1 text-slate-600">
                <li>Vào <code>/products/[id]</code> căn đó → Sửa</li>
                <li>Đổi field <b>%PMG_LK_sale (M current)</b> từ 7% → 8%</li>
                <li>Save căn</li>
                <li>Vào form ĐC giá vốn → nhập M mới (VD 7.5%, 8%)</li>
              </ol>
              <div className="text-xs text-amber-700 mt-2">
                ⚠️ Nếu nhập M vượt ceiling trước khi update products → form sẽ hiện warning.
                Đừng bỏ qua warning, sửa ceiling trước.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-slate-50 rounded-lg p-4">
        ...
        <ul className="text-sm space-y-1 text-slate-700">
          ...
          <li>• Progress bar &lt; 100% mức tối đa</li>
          <li>• Không có warning đỏ hoặc vàng</li>
        </ul>
      </section>
      ...
      <section className="bg-amber-50 border border-amber-200 rounded-lg p-4">
        ...
        <ul className="text-sm space-y-2 text-slate-700">
          <li>
            <b>Nhầm cột M với cột N:</b> N là % khách trả CĐT (thường 70%, 80%, 90%). M là rate CĐT chi (thường 5%-7%). Đừng nhập ngược.
          </li>
          <li>
            <b>Không nhập M khi cần thiết:</b> nếu để trống M, app dùng default = pmg_sale_rate từ products.
            Với pattern mới (CĐT chi rải rác), <b>phải nhập M</b> mỗi đợt vì rate khác nhau.
          </li>
          <li>
            <b>Nhập M lũy kế nhầm đợt này:</b> M là <b>cumulative</b> đến ngày ĐC.
            Đừng nhập rate CĐT chi lẻ đợt này (VD 0.175%), phải nhập cumulative (6.925%).
          </li>
        </ul>
      </section>
    </div>
