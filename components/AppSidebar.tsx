...
const NAV: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/expenses", label: "Yêu cầu chi", resource: "expenses" },
  ...
  // vị trí quyết định vào được những trang nào.
  {
    ...
    children: [
      ...
      { href: "/admin/positions", label: "Vị trí", resource: "positions" },
    ],
  },
  {
    label: "Quản trị",
    children: [
      ...
      { href: "/settings/integrations", label: "Tích hợp", resource: "admin.integrations" },
