                ...
                if (!isGroup(n)) {
                  ...
                  return (
                    <SidebarMenuItem key={n.href}>
                      <SidebarMenuButton
                        isActive={active}
                        className="data-[active=true]:bg-orange-500 data-[active=true]:text-white data-[active=true]:font-semibold data-[active=true]:hover:bg-orange-600 data-[active=true]:hover:text-white"
